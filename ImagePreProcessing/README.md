...
Download Raw Data Files .([https://hkuhk-my.sharepoint.com/:f:/g/personal/rashmism_hku_hk/Emj-XoKWReNFo0hiK87UipwBMWGriXSO_900W6F3QFbggw?e=SSH6xA])
<br>
...
If you're using a command-line interface or scripting, you can use commands like `wget` or `curl` for downloading, `unzip` or `tar` for extracting, and `cp` or `mv` for copying files.

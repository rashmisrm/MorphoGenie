...
conda install -c anaconda pandas=1.4.2 matplotlib=3.5.1 seaborn=0.11.2 umap-learn=0.5.2 numpy=1.21.6 tqdm=4.63.0 scikit-image umap-learn scikit-learn=1.0.2 pillow=9.2.0

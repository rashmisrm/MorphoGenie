...
Load the pre-trained model and select the dataset for testing

Change the python test code here
```

Load the model to test with the desired dataset

	- Moprhological Features Extraction: VAE for downstream classification analysis and interpretation
